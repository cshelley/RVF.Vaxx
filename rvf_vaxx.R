...
rvf_vaxx <- function(t, state, parameters) {
  with(as.list(c(state, parameters)),{
    ...
    # Human Hosts:
    dVH = nuH*nuTH*(SH + EH + IH + RH) - rhoVH*VH - muH*VH + gammaH*NH
    dSH = -betaAH*SH*IA/Na - betaBH*SH*IB/NB + rhoRH*RH - nuH*nuTH*SH + rhoVH*VH - muH*SH
    ...
    # Mammalian Hosts:
    dVM = nuM*nuTM*(SM + EM + IM + RM) - rhoVM*VM - muM*VM
